// Spotify show/podcast ID — open.spotify.com/show/BURAYA_ID
    ...
    if (!SPOTIFY_SHOW_ID) {
        return (
            <div className="flex flex-col items-center justify-center h-full gap-3 py-6">
                ...
                <p className="text-xs text-center" style={{ color: "rgba(224,242,254,0.25)" }}>
                    Spotify podcast linki<br />henüz eklenmedi
                </p>
            </div>
        );
    }
