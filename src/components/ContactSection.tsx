        ...
        <section id="iletisim" className="relative z-10 px-4 sm:px-8 py-20 max-w-5xl mx-auto w-full">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="flex flex-col gap-4">
                    <p className="text-[10px] font-medium tracking-[0.15em] uppercase" style={{ color: "var(--text-4)" }}>
                        Kanallar
                    </p>
                        ...
                        <a key={label} href={href} target={href.startsWith("mailto") ? undefined : "_blank"}
                           ...
                           style={{ background: bg, border: `1px solid ${border}` }}>
                            <div className="w-10 h-10 rounded-xl flex items-center justify-center shrink-0"
                                 style={{ background: "var(--bg-2)", border: `1px solid ${border}`, color }}>
                ...
                <div className="rounded-2xl p-6"
                    ...
                    <p className="text-[10px] font-medium tracking-[0.15em] uppercase mb-5" style={{ color: "var(--text-4)" }}>
                        Mesaj Gönder
                    </p>
                    <ContactForm />
                </div>
