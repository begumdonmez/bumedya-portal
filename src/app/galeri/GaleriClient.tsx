        ...
        <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-4"
            ...
            <div className="w-full max-w-lg rounded-3xl overflow-hidden"
                ...
                <div className="flex items-center justify-between px-6 py-5 border-b"
                    ...
                    <h2 className="text-sm font-semibold" style={{ color: "#E0F2FE" }}>Galeriye Ekle</h2>
                ...
                <div className="p-6 flex flex-col gap-5 max-h-[80vh] overflow-y-auto">
                    ...
                    <div>
                        <p className="text-[10px] tracking-widest uppercase mb-3" style={{ color: "rgba(224,242,254,0.25)" }}>
                            Resim <span style={{ color: "rgba(224,242,254,0.12)" }}>(maks. 5 MB)</span>
                        </p>
                        {preview ? (
                    ...
                    <div>
                        <p className="text-[10px] tracking-widest uppercase mb-2" style={{ color: "rgba(224,242,254,0.25)" }}>
                            Başlık <span style={{ color: "rgba(224,242,254,0.12)" }}>(opsiyonel)</span>
                        </p>
                        <input
                            value={title}
                                    ...
                                    <div key={item.id} className="card break-inside-avoid relative group rounded-2xl overflow-hidden">
                                        {ytId ? (
                                            ...
                                            <a href={item.ref_url} target="_blank" rel="noopener noreferrer">
                                                {/* eslint-disable-next-line @next/next/no-img-element */}
                                                <img src={item.ref_url} alt={item.title ?? "eser"} className="w-full h-auto object-cover" />
                                            </a>
                                        ) : (
                                            <a href={item.ref_url} target="_blank" rel="noopener noreferrer"
                                               ...
                                               style={{ color: "rgba(167,139,250,0.8)" }}>
                                                ...
                                                <div className="min-w-0">
                                                    {item.title && <p className="text-xs font-medium mb-0.5" style={{ color: "#E0F2FE" }}>{item.title}</p>}
                                                    <p className="text-[11px] truncate" style={{ color: "rgba(224,242,254,0.4)" }}>{item.ref_url}</p>
                                                </div>
                                                    ...
                                                    <div className="flex items-center gap-2">
                                                        {item.ref_url && (
                                                            <a href={item.ref_url} target="_blank" rel="noopener noreferrer"
                                                               ...
                                                               style={{ background: "rgba(124,58,237,0.2)", border: "1px solid rgba(124,58,237,0.3)", color: "rgba(167,139,250,0.9)" }}
