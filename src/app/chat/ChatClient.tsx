        ...
        <div className="flex flex-1 min-h-0 overflow-hidden" style={{ background: "#0A0F1E" }}>
            ...
            <aside className="w-60 shrink-0 flex flex-col"
                ...
                <div className="flex-1 px-3 py-4 flex flex-col gap-0.5 overflow-y-auto">
                    <p className="text-[9px] tracking-widest uppercase px-3 mb-2" style={{ color: "rgba(224,242,254,0.18)" }}>
                        ODALAR
                    </p>
                    {ROOMS.map((room) => {
            ...
            <div className="flex-1 flex flex-col min-w-0">
                ...
                {/* Header */}
                <div className="shrink-0 px-6 h-[60px] flex items-center gap-4 border-b"
                ...
                <div className="shrink-0 px-6 pb-6 pt-3">
                    <div className="rounded-2xl overflow-hidden transition-all duration-200"
                        ...
                        <div className="flex items-center justify-between px-4 pb-3 pt-1">
                            <span className="text-[10px]" style={{ color: "rgba(224,242,254,0.15)" }}>
